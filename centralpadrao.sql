...
CREATE TABLE `contas_a_receber` (
  ...
  `status` enum('pendente','recebida','atrasada') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pendente',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `pedido_id` bigint unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `contas_a_receber_pedido_id_foreign` (`pedido_id`),
  ...
  CONSTRAINT `contas_a_receber_pedido_id_foreign` FOREIGN KEY (`pedido_id`) REFERENCES `pedidos` (`id`) ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-10-02 11:52:05
