                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ $cliente->exists ? route('clientes.update', $cliente->id) : route('clientes.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
                            ...
                            <div class="md:col-span-1">
                                <x-input-label for="ie" value="Inscrição Estadual (IE)" />
                                <x-text-input id="ie" name="ie" type="text" class="mt-1 block w-full" :value="old('ie', $cliente->ie ?? '')" placeholder="Deixar em branco se não houver" />
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-6 gap-6 mt-4">
                            ...
                            <div class="md:col-span-2">
                                <x-input-label for="codigo_municipio" value="Cód. Município (IBGE)" />
                                <x-text-input id="codigo_municipio" name="codigo_municipio" type="text" class="mt-1 block w-full" :value="old('codigo_municipio', $cliente->codigo_municipio ?? '')" />
                            </div>
                             <div class="md:col-span-1">
