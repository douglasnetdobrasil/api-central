...
<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div x-data="orcamentoForm()">
                {{-- A CORREÇÃO do 'Enter' começa aqui, com o @submit.prevent --}}
                                        ...
                                        <tr class="border-t border-gray-200 dark:border-gray-700">
                                            <td class="py-2 pr-2 relative">
                                                ...
                                                <x-text-input type="text"
                                                    ...
                                                    {{-- O @keydown.enter.prevent impede o envio do formulário ao teclar Enter aqui --}}
    ...
    <script>
        function orcamentoForm() {
            return {
                items: [{ produto_id: null, produto_nome: '', quantidade: 1, valor_unitario: 0, searchResults: [] }],
                total: 0,
                // ... (métodos addItem, removeItem, calculateTotals, formatCurrency permanecem os mesmos) ...
                ...
                async searchProducts(index, term) {
                    ...
                    try {
                        ...
                        // ===== INÍCIO DA MELHORIA =====
                        // Verifica se a resposta foi um redirecionamento (ex: para a página de login)
                        if (response.redirected) {
                            // Se a sessão expirou, a página será a de login. Recarrega a janela.
                        ...
                        this.items[index].searchResults = products;
                    } catch (error) {
                        console.error('Erro ao buscar produtos:', error);
                        // Limpa os resultados em caso de erro para não travar o dropdown
                        this.items[index].searchResults = [];
                    }
                },
                ...
                selectProduct(index, produto) {
                    ...
                    this.$nextTick(() => {
                        document.querySelector(`input[name='items[${index}][quantidade]']`).focus();
                    });
                },
                
                // ... (outros métodos como addItem, removeItem, etc.)
